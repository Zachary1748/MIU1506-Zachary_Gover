...
//@interface k1506_AboutMe_Gover_ZacharyObject : NSObject
//@end

@interface k1506_AboutMe_Gover_ZacharyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1506_AboutMe_Gover_ZacharyObject class]])
		{
			for (NSString *key in [[(k1506_AboutMe_Gover_ZacharyObject*)o modules] allKeys])
			{
