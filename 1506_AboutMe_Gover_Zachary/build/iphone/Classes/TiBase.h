...
// in simulator we redefine to format for k1506_AboutMe_Gover_Zachary Developer console
...
{\
	NSString * exceptionName = [@"org.k1506_aboutme_gover_zachary." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1506_aboutme_gover_zachary";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1506_AboutMe_Gover_ZacharyNativeItemNone = -1, 
	UIk1506_AboutMe_Gover_ZacharyNativeItemSpinner = -2,
	UIk1506_AboutMe_Gover_ZacharyNativeItemProgressBar = -3,
	
	UIk1506_AboutMe_Gover_ZacharyNativeItemSlider = -4,
	UIk1506_AboutMe_Gover_ZacharyNativeItemSwitch = -5,
	UIk1506_AboutMe_Gover_ZacharyNativeItemMultiButton = -6,
	UIk1506_AboutMe_Gover_ZacharyNativeItemSegmented = -7,
	
	UIk1506_AboutMe_Gover_ZacharyNativeItemTextView = -8,
	UIk1506_AboutMe_Gover_ZacharyNativeItemTextField = -9,
	UIk1506_AboutMe_Gover_ZacharyNativeItemSearchBar = -10,
	
	UIk1506_AboutMe_Gover_ZacharyNativeItemPicker = -11,
	UIk1506_AboutMe_Gover_ZacharyNativeItemDatePicker = -12,
	
	UIk1506_AboutMe_Gover_ZacharyNativeItemInfoLight = -13,
	UIk1506_AboutMe_Gover_ZacharyNativeItemInfoDark = -14,
	
	UIk1506_AboutMe_Gover_ZacharyNativeItemDisclosure = -15,
	
	UIk1506_AboutMe_Gover_ZacharyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1506_AboutMe_Gover_Zachary instances of
