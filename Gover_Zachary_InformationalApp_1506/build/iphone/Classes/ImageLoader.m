...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.gover_zachary_informationalapp_1506._gover_zachary_informationalapp_1506.imageloader" code:1 userInfo:errorDetail];
