...
/**
 The base class for all Gover_Zachary_InformationalApp_1506 modules
 */
...
/**
 Gover_Zachary_InformationalApp_1506 Platform calls this method on startup.
 */
-(void)startup;

/**
 Gover_Zachary_InformationalApp_1506 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Gover_Zachary_InformationalApp_1506 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Gover_Zachary_InformationalApp_1506 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Gover_Zachary_InformationalApp_1506 Platform calls this method on resume.
 @param sender The sender of the event.
 */
