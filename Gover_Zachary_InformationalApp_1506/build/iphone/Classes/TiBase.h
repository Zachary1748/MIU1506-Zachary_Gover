...
// in simulator we redefine to format for Gover_Zachary_InformationalApp_1506 Developer console
...
{\
	NSString * exceptionName = [@"org.gover_zachary_informationalapp_1506." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gover_zachary_informationalapp_1506";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGover_Zachary_InformationalApp_1506NativeItemNone = -1, 
	UIGover_Zachary_InformationalApp_1506NativeItemSpinner = -2,
	UIGover_Zachary_InformationalApp_1506NativeItemProgressBar = -3,
	
	UIGover_Zachary_InformationalApp_1506NativeItemSlider = -4,
	UIGover_Zachary_InformationalApp_1506NativeItemSwitch = -5,
	UIGover_Zachary_InformationalApp_1506NativeItemMultiButton = -6,
	UIGover_Zachary_InformationalApp_1506NativeItemSegmented = -7,
	
	UIGover_Zachary_InformationalApp_1506NativeItemTextView = -8,
	UIGover_Zachary_InformationalApp_1506NativeItemTextField = -9,
	UIGover_Zachary_InformationalApp_1506NativeItemSearchBar = -10,
	
	UIGover_Zachary_InformationalApp_1506NativeItemPicker = -11,
	UIGover_Zachary_InformationalApp_1506NativeItemDatePicker = -12,
	
	UIGover_Zachary_InformationalApp_1506NativeItemInfoLight = -13,
	UIGover_Zachary_InformationalApp_1506NativeItemInfoDark = -14,
	
	UIGover_Zachary_InformationalApp_1506NativeItemDisclosure = -15,
	
	UIGover_Zachary_InformationalApp_1506NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Gover_Zachary_InformationalApp_1506 instances of
