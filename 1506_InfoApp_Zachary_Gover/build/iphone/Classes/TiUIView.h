...
/**
 Base class for all Gover_Zachary_InformationalApp_1506 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Gover_Zachary_InformationalApp_1506 view hierarchy (such as wrapped iOS UIViews) was touched.
