...
//@interface Gover_Zachary_InformationalApp_1506Object : NSObject
//@end

@interface Gover_Zachary_InformationalApp_1506Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Gover_Zachary_InformationalApp_1506Object class]])
		{
			for (NSString *key in [[(Gover_Zachary_InformationalApp_1506Object*)o modules] allKeys])
			{
