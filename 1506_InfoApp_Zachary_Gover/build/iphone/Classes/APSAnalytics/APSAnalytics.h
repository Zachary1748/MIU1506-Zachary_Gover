 ...
 * to send analytic data that can be viewed on the Gover_Zachary_InformationalApp_1506 Dashboard.
 *
 * For information on getting started with Gover_Zachary_InformationalApp_1506 Platform Services,
