...
@interface k1506_UtilityApp_Gover_ZacharyObject : KrollCoverageObject {
#else
@interface k1506_UtilityApp_Gover_ZacharyObject : KrollObject {
#endif
@private
...
extern NSString * k1506_UtilityApp_Gover_Zachary$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1506_UtilityApp_Gover_ZacharyObject *_k1506_utilityapp_gover_zachary;
    KrollObject* console;
	BOOL shutdown;
