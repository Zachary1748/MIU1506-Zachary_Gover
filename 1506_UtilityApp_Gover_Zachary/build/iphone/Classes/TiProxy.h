...
//Rare exceptions to indicate a bug in the _k1506_utilityapp_gover_zachary code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1506_UtilityApp_Gover_Zachary proxies.
 */
