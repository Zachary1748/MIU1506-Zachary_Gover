...
/**
 Base class for all k1506_UtilityApp_Gover_Zachary views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1506_UtilityApp_Gover_Zachary view hierarchy (such as wrapped iOS UIViews) was touched.
